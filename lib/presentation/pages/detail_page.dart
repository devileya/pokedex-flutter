...
import '../widget/pokemon_attribute_card.dart';
import '../widget/pokemon_status.dart';
...
class _DetailPageState extends State<DetailPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      dominantColor = await computeDominateImageColor(_pokemon?.imageUrl ?? '');
            ...
            return SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                    textStyle: const TextStyle(color: Colors.white), backgroundColor: isFavorite == true
              ...
              child: Container(
                  ...
                  child: ListView(padding: EdgeInsets.zero, children: [
                    ...
                    ..._pokemon?.stats?.map((e) => Padding(
                      ...
                      child: Column(
                        children: [
                          PokemonStatus(title: e.name, value: e.baseStat),
